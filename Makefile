...
prepare-release:
	...
	cd governatooorr/; git fetch origin --tags --force; git checkout $$(git tag --sort=committerdate | tail -n 1)
	cd mech/; git fetch origin --tags --force; git checkout $$(git tag --sort=committerdate | tail -n 1)
	cd agent-academy-2/; git fetch origin --tags --force; git checkout $$(git tag --sort=committerdate | tail -n 1)
	cd open-acn/; git fetch origin --tags --force; git checkout $$(git tag --sort=committerdate | tail -n 1)
	cd hello-world/; git fetch origin --tags --force; git checkout $$(git tag --sort=committerdate | tail -n 1)
